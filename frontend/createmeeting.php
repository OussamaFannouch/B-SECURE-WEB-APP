...
.nav-link i {
    ...
    <nav class="nav-links">
        <?php if ($_SESSION['role'] === 'admin'): ?>
            <a href="/Bseccopie/frontend/createmeeting.php" class="nav-link create-meeting">
                <i class="fas fa-plus"></i> Create Meeting
            </a>
        <?php endif; ?>
        <a href="/Bseccopie/frontend/dashboard.php" class="nav-link view-meetings">
            <i class="fas fa-calendar"></i> View Meetings
        </a>
        <a href="/Bseccopie/frontend/auth/login.php" class="nav-link logout">
    ...
    <div class="container">
        ...
        <form action="/Bseccopie/frontend/createmeeting.php" method="POST">
